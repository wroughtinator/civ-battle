...
export class Soundscape {
 ...
 async unlock(){if(!this.enabled)return;try{
  ...
  this.loading=true;const [manifest,response]=await Promise.all([fetch('/releases/f1437ddd81616c12f6b76206/assets/audio/cues.json').then(r=>r.json()),fetch('/releases/f1437ddd81616c12f6b76206/assets/audio/game-audio.mp3')]);this.cues=manifest;this.buffer=await this.ctx.decodeAudioData(await response.arrayBuffer());this.ready=true;
