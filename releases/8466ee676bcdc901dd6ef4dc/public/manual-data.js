...
export const manualEntries={
 ...
 hand:['Stop','Stops the unit after its current hex crossing. Also stops city construction; the founding fee is not returned. It cannot interrupt an attack’s commitment. Disabled when there is no route or construction to stop.'],
 ...
 sail:['Water / embarkation','Naval units require a coastal city and stay on water. Most land units can embark, but crossings are slow and they cannot attack while embarked. A sail on a disabled recruit button means the city has no adjacent ocean hex. A sail discovery is a wrecked caravan.'],
