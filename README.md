...
- 33 researchable units span eleven branches through three colored eras: Stone & Bronze, Industry & Sail, Modern & Space. Tap a technology to queue its prerequisite path automatically. Orbital engineer requires Rocket Battery and Radar Truck, not the whole tree; unrelated branches can be skipped.
- Orders have no shared cooldown; routes, weapons, healing and research continue automatically. Directional palisades, bulwarks and floating barriers protect their fronts; flank them or bring siege. Medics, supply carts, radar and shield trucks support formations without repeated ability clicks.
